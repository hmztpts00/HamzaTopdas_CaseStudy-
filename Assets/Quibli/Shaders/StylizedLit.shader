Shader "Quibli/Stylized Lit"
{
    Properties
    {
        ...
        [Space(20)]_DetailMap("Detail Map", 2D) = "white" {}
        ...
        [Space][Toggle(DR_LIGHT_ATTENUATION)]_OverrideLightAttenuation("Override Realtime Shadow", Int) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexOutput VertexProgram(VertexInput v) {
                ...
                float4 clipPosition = ObjectToClipPos(v.position);
